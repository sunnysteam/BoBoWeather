    ...
    public class NotificationAreaIcon : FrameworkElement
    {
        ...
        protected override void OnInitialized(EventArgs e)
        {
            ...
            if (this.MenuItems != null && this.MenuItems.Count > 0)
            {
                ...
                notifyIcon.ContextMenu = new Forms.ContextMenu(MenuItems.ToArray());
                //notifyIcon.ContextMenuStrip = new Forms.ContextMenuStrip()
                //{
                //    DefaultDropDownDirection = Forms.ToolStripDropDownDirection.AboveRight,
                //    DropShadowEnabled = true
                //};

                //foreach (var item in MenuItems.ToArray())
                //{
                //    notifyIcon.ContextMenuStrip.Items.Add(item.Text);
                //}
            }
